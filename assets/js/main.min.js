...
function removeActiveHome() {
  document.querySelector('.header-menu .menu-nav .active').classList.remove('active');
  document.querySelector('.header-menu .menu-nav-mobile .active').classList.remove('active');
}
